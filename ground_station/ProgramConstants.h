...
namespace LogConstants {
    ...
    static const std::string WORKER_ATCOMMAND_LOG_PATH("ATData/responses");
    static const std::string RECEIVER_LOG_PATH("ReceiversData/packets_received");
}
...
namespace CommunicationsConstants {
    ...
    static constexpr int AT_COMMAND_TYPE = 5;
}
